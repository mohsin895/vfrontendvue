    ...
    <div class="create-application">
        <form @submit.prevent="goNextPage()">
                            ...
                            <b-col>
                                <div class="applicant">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" v-model="applicant.aNID" class="form-control" :id="'a_nid'+(index+1)" maxlength="17"  required >
                                    </div>
                                    <div class="mb-3">
                            ...
                            <b-col>
                                <div class="opponent">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" v-model="opponent.oNID" class="form-control" :id="'o_nid'+(index+1)" maxlength="17" required>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <b-col>
                                <div class="witness">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" v-model="witness.wNID" class="form-control" :id="'w_nid'+(index+1)" maxlength="17" required>
                                    </div>
                                    <div class="mb-3">
                ...
                <div class="button-group">
                    <button class="btn-global-success">পরবতীতে যান</button>
                </div>
            </div>
        </form>
        <form @submit.prevent>
            ...
            <div class="page-two" v-if="currentPage === 2">
                ...
                <b-row cols="1" cols-lg="2" v-if="interestedToAddNomminator">
                    ...
                    <b-col>
                        ...
                        <div class="mb-3">
                            ...
                            <!-- <input type="number" v-model="form.localPerson.wardNo" class="form-control" id="local_m_ward" required> -->
                ...
                <div class="button-group">
                    <a class="btn-global-danger" @click="backPreviousPage()">পিছনে যান</a>
                    <button class="btn-global-success" :disabled="countDown>0" @click="submitForm">সাবমিট করুন</button>
                </div>
            </div>
        </form>
...
export default {
    ...
    methods: {
        sendConfirmationMessage(){
            let url="frontend/application/confirmation?caseNo="+this.caseId;
        ...
        async submitForm() {
            ...
            if(this.witnessForm){
               ...
               formData.append("union",this.form.union);
                ...
                let url="frontend/new/case/submit";
